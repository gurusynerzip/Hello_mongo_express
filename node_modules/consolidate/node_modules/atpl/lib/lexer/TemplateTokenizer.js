            ...
            switch (this.state) {
                ...
                case 2:
                    ...
                    switch (this.openChars) {
                        ...
                        case '{{':
                        case '{%':
                            var expressionTokenizer = new ExpressionTokenizer.ExpressionTokenizer(new StringReader(this.stringReader.getSliceWithCallback(function () {
                                (new ExpressionTokenizer.ExpressionTokenizer(_this.stringReader)).tokenizeAll();
                            })));
...
module.exports = TemplateTokenizer;
